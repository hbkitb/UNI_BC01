report 50002 "SalInvBrTek"
{
    RDLCLayout = './StandardSalesInvoice.rdlc';
    WordLayout = 'REP/layout/SalFakBrDK.docx';    //'./StandardSalesInvoice.docx';
    ...
    dataset
    {
        dataitem(Header; "Sales Invoice Header")
        {
            ...
            begin
                ...
                //HBK / ITB - 161121 On Prem               PaymentInstructionsTxt := O365SalesInvoiceMgmt.GetPaymentInstructionsFromPostedInvoice(Header);
#endif
